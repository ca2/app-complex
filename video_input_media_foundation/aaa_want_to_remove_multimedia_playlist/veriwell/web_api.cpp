...
pdirectorysystem->system() / "config\\waven\\access_token.txt");
         m_strTokenType = file()->as_string(         auto psystem = system();

         auto pdirectorysystem = psystem->m_pdirectorysystem;

pdirectorysystem->system() / "config\\waven\\token_type.txt");
         m_iExpires = atoi(file()->as_string(         auto psystem = system();

         auto pdirectorysystem = psystem->m_pdirectorysystem;

pdirectorysystem->system() / "config\\waven\\expire_in.txt"));
...
pdirectorysystem->system() / "config\\waven\\time_auth.txt"));
...
pdirectorysystem->system() / "config\\spotify\\client_id.txt");
...
pdirectorysystem->system() / "config\\spotify\\client_secret.txt");
...
pdirectorysystem->system() / "config\\waven\\access_token.txt", m_strAccessToken);
         file()->put_contents(         auto psystem = system();

         auto pdirectorysystem = psystem->m_pdirectorysystem;

pdirectorysystem->system() / "config\\waven\\token_type.txt", m_strTokenType);
         file()->put_contents(         auto psystem = system();

         auto pdirectorysystem = psystem->m_pdirectorysystem;

pdirectorysystem->system() / "config\\waven\\expire_in.txt", as_string(m_iExpires));
         file()->put_contents(         auto psystem = system();

         auto pdirectorysystem = psystem->m_pdirectorysystem;

pdirectorysystem->system() / "config\\waven\\refresh_token.txt", m_strRefreshToken);
         file()->put_contents(         auto psystem = system();
