...
//#include "framework.h"
#include <windows.h>
//#include "video_input_media_foundation.h"
//#include "highgui.h"

#pragma comment(lib, "lib\\opencv\\Release\\opencv_highgui242.lib")
#pragma comment(lib, "lib\\opencv\\Release\\opencv_core242.lib")

#pragma comment(lib, "video_input_media_foundation.lib")

void StopEvent(int deviceID, void * userData)
{
   video_input_media_foundation * VI = &video_input_media_foundation::get_instance();
