...
namespace mediaplaylist
{
   ...
   void impact::on_create_split_impact()
   {
      ...
      create_impact < mediaplaylist::playlist_list_impact >(get_document(),::f64_rectangle(),get_pane_holder(0),"playlist_list_impact");

      create_impact < mediaplaylist::list_impact >(get_document(),::f64_rectangle(),get_pane_holder(1),"list_impact");
