...
/*   void tree::OnDraw(::image::image *pimage)
   ...
   void tree::_001OnOpenItem(::pointer<::data::tree_item>pitem, const ::action_context & context)
   {
      ...
      cc.m_typeatomNewImpact = typeid(right_impact );
      create_impact(typeid(right_impact ), get_document(), get_parent(), 101);
      }
      if(papp->mediaplaylist::application::m_pmaillist == NULL)
      return;
      ...
      else if(papp->mediaplaylist::application::m_pmainimpact == NULL)
      {
...
//      ::data::lock lock(m_spdata);
   ...
   void tree::create_tree(::pointer<::xml::node>pnode, ::pointer<::data::tree_item>itemParent)
   {
      ...
      {
         ::pointer<::mediaplaylist::item>pitem = canew (:mediaplaylist::item(this));
