...
namespace mediaplaylist
{
   ...
   void list_impact::handle(::topic * ptopic, ::context * pcontext)
   {
      ...
      if(pupdate != nullptr)
      {
         ...
         case ::update::HintInitial:
         {
            _001UpdateColumns();
            _001OnUpdateItemCount();
            handle(::topic * ptopic, ::context * pcontext);
         }
         break;
         }
      }
   ...
   void list_impact::handle(::topic * ptopic, ::context * pcontext)
   {
      ...
      FORMATTED_TRACE("list_impact::OnInitialUpdate() oswindow = %d\n", get_handle());
...
//      ::user::list::_001DrawBackground(pgraphics, lprect);
   ...
   void list_impact::on_message_create(::message::message * pmessage)
   {
      ...
      m_pimagelistSubItemHover   = memory_new image_list(this);
      m_pimagelistNormal         = memory_new image_list(this);
      m_pimagelistItemHover      = memory_new image_list(this);
      ...
      m_pimagelistGroupHover   = memory_new image_list(this);
