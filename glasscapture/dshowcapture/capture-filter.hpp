...
typedef void OnIMediaSample(IMediaSample *sample);
struct PinCaptureInfo {
   OnIMediaSample *                           callback;
...
public:
	...
	STDMETHODIMP FindPin(const widechar * Id, IPin **ppPin);
	STDMETHODIMP QueryFilterInfo(FILTER_INFO *pInfo);
	STDMETHODIMP JoinFilterGraph(IFilterGraph *pGraph, const widechar * pName);
