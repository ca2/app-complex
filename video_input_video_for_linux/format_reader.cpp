...
HRESULT SpecialCaseAttributeValueNew(GUID guid, const prop_variant& var, ::video_input::media_format &out);

unsigned int *GetParametr(GUID guid, ::video_input::media_format &out)
{
...
HRESULT LogAttributeValueByIndexNew(IMFAttributes *pAttr, DWORD index, ::video_input::media_format &out)
{
...
namespace video_input_video_for_linux
{
   ...
   ::video_input::media_format format_reader::Read(IMFMediaType * pmediatype)
   {
      UINT32 m_cCount = 0;

      HRESULT hr = S_OK;

      ::video_input::media_format out;
