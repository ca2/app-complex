...
namespace mediamanager
{
   ...
   public:
      ...
      void GetExistingFiles(::i32_array & ia,::file::listing & straFile,time_array_base & array);
      void GetExistingFiles(::pointer<::database::result_set>pset,::i32_array & ia,::file::listing & straFile,time_array_base & array);
