...
//   string_array stra;
//
//   for (index i = 0; i < v["data"]["detections"][0].payloada().get_count(); i++)
//   {
//
...
////
////      add_factory_item <::audio_mixer_userbase::document >();
////      add_factory_item <::audio_mixer_userbase::frame_window >();
////      add_factory_item <::audio_mixer_userbase::main_impact >();
////      add_factory_item <::audio_mixer_userbase::control_impact >();
////
