...
HRESULT LogAttributeValueByIndexNew(IMFAttributes *pAttr, DWORD index, ::video_input_media_capture::media_format * pmediaformat)
{
...
HRESULT SpecialCaseAttributeValueNew(GUID guid, const prop_variant& var, ::video_input_media_capture::media_format * pmediaformat)
{
...
namespace video_input_media_capture
{
   ...
   ::pointer<::video_input::media_format>format_reader::Read(IMFMediaType * pmediatype)
   {
      ...
      auto pmediaformat = createø < ::video_input::media_format >();
