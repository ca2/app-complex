...
namespace mediaplaylist
{
   ...
   void list_impact::_001OnGetUri(::message::message * pmessage)
   {
      ...
      for (index i = 0; i < range.get_item_count(); i++)
      {
         ...
         for (index j = range.m_itemrangea[i].m_iLowerBound; j <= range.m_itemrangea[i].m_iUpperBound; j++)
         {
...
//      ::user::list::_001DrawBackground(pgraphics, lprect);
   ...
   void list_impact::on_message_create(::message::message * pmessage)
   {
      ...
      m_pimagelistGroupHover = __new(image_list);
...
//}
   ...
   void list_impact::_000OnDraw(::draw2d::graphics_pointer & pgraphics)
   {
      ...
      //   information("Exception: interaction::_000OnDraw _001DrawThis %s", __type_name(this));
      ...
      //      information("Exception: interaction::_000OnDraw _001DrawChildren %s", __type_name(this));
      ...
      //   information("Exception: interaction::_000OnDraw _008CallOnDraw %s", __type_name(this));
