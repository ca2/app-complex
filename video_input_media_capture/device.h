...
namespace video_input_media_capture
{
	...
	class CLASS_DECL_VIDEO_INPUT_MEDIA_CAPTURE device :
	...
	public:
      ...
      ::winrt::Windows::Media::Capture::Frames::MediaFrameSourceGroup         m_mediaframesourcegroup = nullptr;
      ::winrt::Windows::Media::Capture::Frames::MediaFrameSourceInfo          m_mediaframesourceinfo = nullptr;
      ::winrt::Windows::Media::Capture::Frames::MediaFrameSource              m_mediaframesource = nullptr;
