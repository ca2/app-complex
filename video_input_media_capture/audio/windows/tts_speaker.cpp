...
namespace windows
{
   ...
   namespace tts
   {
      ...
      bool speaker::speak(const ::scoped_string & scopedstrLangParam, const ::scoped_string & scopedstrTextParam, bool bSync)
      {
         ...
         auto paudio = ::get_context_audio(this);
         ...
         auto paudioAudio = paudio->cast < ::audio::audio >();
         ...
         paudioAudio->play_audio(pfile, bSync);
      ...
      bool speaker::speak(const ::scoped_string & scopedstrAttributes, const ::scoped_string & scopedstrLangParam, const ::scoped_string & scopedstrTextParam, bool bSync)
      {
         ...
         ::get_context_audio(this)->cast < ::audio::audio >()->play_audio(pfile, bSync);
...
void ([a-z0-9_]+)_factory(::factory::factory * pfactory)
{
   ...
   add_factory_item < ::windows::tts::speaker, ::tts::speaker >();
