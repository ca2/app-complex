...
namespace wave
{
   ...
   void device_player::OnEvent(enum_player_event eevent, player_command* pcommand)
   {
      ...
      case e_player_event_open_device:
         TRACE("device_player OnEvent e_player_event_open_device");
         SetDeviceState(e_device_state_opened);
         break;
      case e_player_event_open_device_failed:
         TRACE("device_player OnEvent e_player_event_open_device_failed");
         SetDeviceState(e_device_state_initial);
         break;
      case e_player_event_open_decoder:
         TRACE("device_player OnEvent e_player_event_open_decoder");
         SetDecoderState(e_decoder_state_opened);
         break;
      case e_player_event_start_device_failed:
      {

         TRACE("device_player OnEvent e_player_event_start_device_failed");
      ...
      case e_player_event_play:
      {
         ...
         TRACE("device_player OnEvent e_player_event_play");
      ...
      case e_player_event_stop:
      {
         ...
         TRACE("device_player OnEvent e_player_event_stop");
      ...
      case e_player_event_fade_out_and_stop:
      {
         ...
         TRACE("device_player OnEvent e_player_event_fade_out_and_stop");
      ...
      case e_player_event_execute_pause:
      {
         ...
         TRACE("device_player OnEvent EventDeviceOpen");
      ...
      case e_player_event_execute_restart:
      {
         ...
         TRACE("device_player OnEvent e_player_event_execute_restart");
      ...
      case e_player_event_eof:
      {
         ...
         TRACE("device_player OnEvent e_player_event_eof");
      ...
      case e_player_event_playback_end:
      {
         ...
         TRACE("device_player e_player_event_playback_end");
      ...
      case e_player_event_stopped:
      {
         ...
         TRACE("device_player e_player_event_stopped");
      ...
      {
         TRACE("device_player OnEvent e_player_event_close_device");
         SetDeviceState(e_device_state_initial);
      }
      break;
      case e_player_event_close_decoder:
      {
         TRACE("device_player OnEvent e_player_event_close_decoder");
         SetDecoderState(e_decoder_state_initial);
      }
      break;
      case e_player_event_open_decoder_failed:
      {
         TRACE("device_player OnEvent e_player_event_open_decoder_failed");
         SetDecoderState(e_decoder_state_initial);
      }
      break;
      case e_player_event_destroy:
      {
         TRACE("device_player OnEvent e_player_event_destroy");
         SetDeviceState(e_device_state_initial);
      }
      break;
      }
